								...
								<form action="functions/update-user.php" method="post">
									...
									<div class="form-row">
										<div class="form-group">
											<a href="manage-user.php" class="btn btn-secondary"><i class="fas fa-chevron-left fa-fw"></i> Kembali </a>
										</div>
									...
									<small id="phoneHelp" class="form-text ml-3 text-danger">
										Perhatian!!
										<ul>
											<li>Untuk melakukan perubahan pada data pengguna diperlukan akses internet.</li>
											<li>Melakukan perubahan tanpa koneksi internet dapat berakibat user tidak mendapat email informasi pembaruan, termasuk apabila melakukan reset password pada akun user.</li>
										</ul>
									</small>
								</form>
							</div>
