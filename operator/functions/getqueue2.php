...
if (isset($_POST['getqueue2'])) {


    $current_user = $_SESSION['wig_user'];
    $query_getActiveTrx = "SELECT * FROM transactions WHERE trx_status = 'active' AND progress = 'working' AND crew = '$current_user'";
    ...
    if ($activeTrxCounter == 0) {
        echo '<tr>
    <td colspan="8" class="text-center font-weight-bold text-lg">- No Active Task -</td>
</tr>';
    }
