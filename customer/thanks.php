            ...
            <div class="d-flex justify-content-center">
                <div class="text-center">
                    ...
                    <blockquote class="blockquote text-white-50">
                        <p class="mb-0">Your order made our day! We hope we make yours. <br>if you have any questions about your order, contact us any time. we'd love to hear from you</p><br>
                        <footer class="blockquote-footer">Wash Inn Garage Crew <cite title="Source Title"></cite></footer>
                    </blockquote>
                </div>
            </div>
        </div>
